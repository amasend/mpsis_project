...
data = pd.read_csv("data/dane.csv", delimiter=";", names=["From", "To", "year", "month", "day", "Time", "Cost", "From_latitude", 									"From_longitude","To_latitude", "To_longitude", "name"])
data = data.drop(['Time',"From_latitude","From_longitude","To_latitude", "To_longitude", "name"], axis=1)
